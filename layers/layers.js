...
var format_ResidentialMixed800mCommercial500mHousingCurtilage_33 = new ol.format.GeoJSON();
var features_ResidentialMixed800mCommercial500mHousingCurtilage_33 = format_ResidentialMixed800mCommercial500mHousingCurtilage_33.readFeatures(json_ResidentialMixed800mCommercial500mHousingCurtilage_33, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ResidentialMixed800mCommercial500mHousingCurtilage_33 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ResidentialMixed800mCommercial500mHousingCurtilage_33.addFeatures(features_ResidentialMixed800mCommercial500mHousingCurtilage_33);
var lyr_ResidentialMixed800mCommercial500mHousingCurtilage_33 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ResidentialMixed800mCommercial500mHousingCurtilage_33, 
                style: style_ResidentialMixed800mCommercial500mHousingCurtilage_33,
                popuplayertitle: "Residential + Mixed 800m, Commercial 500m (Housing Curtilage)",
                interactive: true,
                title: '<img src="styles/legend/ResidentialMixed800mCommercial500mHousingCurtilage_33.png" /> Residential + Mixed 800m, Commercial 500m (Housing Curtilage)'
            });
var format_HousingCurtillage800mBuffer_34 = new ol.format.GeoJSON();
var features_HousingCurtillage800mBuffer_34 = format_HousingCurtillage800mBuffer_34.readFeatures(json_HousingCurtillage800mBuffer_34, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_HousingCurtillage800mBuffer_34 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_HousingCurtillage800mBuffer_34.addFeatures(features_HousingCurtillage800mBuffer_34);
var lyr_HousingCurtillage800mBuffer_34 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_HousingCurtillage800mBuffer_34, 
                style: style_HousingCurtillage800mBuffer_34,
                popuplayertitle: "Housing Curtillage 800m Buffer",
                interactive: true,
                title: '<img src="styles/legend/HousingCurtillage800mBuffer_34.png" /> Housing Curtillage 800m Buffer'
            });
var format_NaturalDesignatedAreasMergedTogetherTipperary_35 = new ol.format.GeoJSON();
var features_NaturalDesignatedAreasMergedTogetherTipperary_35 = format_NaturalDesignatedAreasMergedTogetherTipperary_35.readFeatures(json_NaturalDesignatedAreasMergedTogetherTipperary_35, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_NaturalDesignatedAreasMergedTogetherTipperary_35 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_NaturalDesignatedAreasMergedTogetherTipperary_35.addFeatures(features_NaturalDesignatedAreasMergedTogetherTipperary_35);
var lyr_NaturalDesignatedAreasMergedTogetherTipperary_35 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_NaturalDesignatedAreasMergedTogetherTipperary_35, 
                style: style_NaturalDesignatedAreasMergedTogetherTipperary_35,
                popuplayertitle: "Natural Designated Areas Merged Together Tipperary",
                interactive: true,
                title: '<img src="styles/legend/NaturalDesignatedAreasMergedTogetherTipperary_35.png" /> Natural Designated Areas Merged Together Tipperary'
            });
var format_RiversTipperary_36 = new ol.format.GeoJSON();
var features_RiversTipperary_36 = format_RiversTipperary_36.readFeatures(json_RiversTipperary_36, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RiversTipperary_36 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RiversTipperary_36.addFeatures(features_RiversTipperary_36);
var lyr_RiversTipperary_36 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RiversTipperary_36, 
                style: style_RiversTipperary_36,
                popuplayertitle: "Rivers Tipperary",
                interactive: true,
                title: '<img src="styles/legend/RiversTipperary_36.png" /> Rivers Tipperary'
            });
var format_ArchaeologyTipperary_37 = new ol.format.GeoJSON();
var features_ArchaeologyTipperary_37 = format_ArchaeologyTipperary_37.readFeatures(json_ArchaeologyTipperary_37, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ArchaeologyTipperary_37 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ArchaeologyTipperary_37.addFeatures(features_ArchaeologyTipperary_37);
var lyr_ArchaeologyTipperary_37 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ArchaeologyTipperary_37, 
                style: style_ArchaeologyTipperary_37,
                popuplayertitle: "Archaeology Tipperary",
                interactive: true,
                title: '<img src="styles/legend/ArchaeologyTipperary_37.png" /> Archaeology Tipperary'
            });
var format_PowerLinesTipperary_38 = new ol.format.GeoJSON();
var features_PowerLinesTipperary_38 = format_PowerLinesTipperary_38.readFeatures(json_PowerLinesTipperary_38, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PowerLinesTipperary_38 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PowerLinesTipperary_38.addFeatures(features_PowerLinesTipperary_38);
var lyr_PowerLinesTipperary_38 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PowerLinesTipperary_38, 
                style: style_PowerLinesTipperary_38,
                popuplayertitle: "Power Lines Tipperary",
                interactive: true,
                title: '<img src="styles/legend/PowerLinesTipperary_38.png" /> Power Lines Tipperary'
            });
var format_PowerPolesTipperary_39 = new ol.format.GeoJSON();
var features_PowerPolesTipperary_39 = format_PowerPolesTipperary_39.readFeatures(json_PowerPolesTipperary_39, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_PowerPolesTipperary_39 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PowerPolesTipperary_39.addFeatures(features_PowerPolesTipperary_39);
var lyr_PowerPolesTipperary_39 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PowerPolesTipperary_39, 
                style: style_PowerPolesTipperary_39,
                popuplayertitle: "Power Poles Tipperary",
                interactive: true,
                title: '<img src="styles/legend/PowerPolesTipperary_39.png" /> Power Poles Tipperary'
            });
var format_10mRoadBuffer_40 = new ol.format.GeoJSON();
var features_10mRoadBuffer_40 = format_10mRoadBuffer_40.readFeatures(json_10mRoadBuffer_40, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_10mRoadBuffer_40 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_10mRoadBuffer_40.addFeatures(features_10mRoadBuffer_40);
var lyr_10mRoadBuffer_40 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_10mRoadBuffer_40, 
                style: style_10mRoadBuffer_40,
                popuplayertitle: "10m Road Buffer",
                interactive: true,
                title: '<img src="styles/legend/10mRoadBuffer_40.png" /> 10m Road Buffer'
            });
var format_Roads_41 = new ol.format.GeoJSON();
var features_Roads_41 = format_Roads_41.readFeatures(json_Roads_41, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Roads_41 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Roads_41.addFeatures(features_Roads_41);
var lyr_Roads_41 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Roads_41, 
                style: style_Roads_41,
                popuplayertitle: "Roads",
                interactive: true,
                title: '<img src="styles/legend/Roads_41.png" /> Roads'
            });
var format_EircodesCreating800m_42 = new ol.format.GeoJSON();
var features_EircodesCreating800m_42 = format_EircodesCreating800m_42.readFeatures(json_EircodesCreating800m_42, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EircodesCreating800m_42 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EircodesCreating800m_42.addFeatures(features_EircodesCreating800m_42);
var lyr_EircodesCreating800m_42 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EircodesCreating800m_42, 
                style: style_EircodesCreating800m_42,
                popuplayertitle: "Eircodes Creating 800m",
                interactive: true,
    title: 'Eircodes Creating 800m<br />\
    <img src="styles/legend/EircodesCreating800m_42_0.png" /> Mixed Address<br />\
    <img src="styles/legend/EircodesCreating800m_42_1.png" /> Non Residential Address<br />\
    <img src="styles/legend/EircodesCreating800m_42_2.png" /> Residential Address<br />'
        });
var format_IndicativeTurbineLocations25x35Ellipses_43 = new ol.format.GeoJSON();
var features_IndicativeTurbineLocations25x35Ellipses_43 = format_IndicativeTurbineLocations25x35Ellipses_43.readFeatures(json_IndicativeTurbineLocations25x35Ellipses_43, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_IndicativeTurbineLocations25x35Ellipses_43 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_IndicativeTurbineLocations25x35Ellipses_43.addFeatures(features_IndicativeTurbineLocations25x35Ellipses_43);
var lyr_IndicativeTurbineLocations25x35Ellipses_43 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_IndicativeTurbineLocations25x35Ellipses_43, 
                style: style_IndicativeTurbineLocations25x35Ellipses_43,
                popuplayertitle: "Indicative Turbine Locations 2.5 x 3.5 Ellipses",
                interactive: true,
                title: '<img src="styles/legend/IndicativeTurbineLocations25x35Ellipses_43.png" /> Indicative Turbine Locations 2.5 x 3.5 Ellipses'
            });
var format_875mOversail_44 = new ol.format.GeoJSON();
var features_875mOversail_44 = format_875mOversail_44.readFeatures(json_875mOversail_44, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_875mOversail_44 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_875mOversail_44.addFeatures(features_875mOversail_44);
var lyr_875mOversail_44 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_875mOversail_44, 
                style: style_875mOversail_44,
                popuplayertitle: "87.5m Oversail",
                interactive: true,
                title: '<img src="styles/legend/875mOversail_44.png" /> 87.5m Oversail'
            });
var format_IndicativeTurbineLocations_45 = new ol.format.GeoJSON();
var features_IndicativeTurbineLocations_45 = format_IndicativeTurbineLocations_45.readFeatures(json_IndicativeTurbineLocations_45, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_IndicativeTurbineLocations_45 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_IndicativeTurbineLocations_45.addFeatures(features_IndicativeTurbineLocations_45);
var lyr_IndicativeTurbineLocations_45 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_IndicativeTurbineLocations_45, 
                style: style_IndicativeTurbineLocations_45,
                popuplayertitle: "Indicative Turbine Locations",
                interactive: true,
                title: '<img src="styles/legend/IndicativeTurbineLocations_45.png" /> Indicative Turbine Locations'
            });
var group_SiteDetails = new ol.layer.Group({
                                layers: [lyr_10mRoadBuffer_40,lyr_Roads_41,lyr_EircodesCreating800m_42,lyr_IndicativeTurbineLocations25x35Ellipses_43,lyr_875mOversail_44,lyr_IndicativeTurbineLocations_45,],
                                fold: "open",
                                title: "Site Details"});
var group_EnvironmentalDesignations = new ol.layer.Group({
                                layers: [lyr_ResidentialMixed800mCommercial500mHousingCurtilage_33,lyr_HousingCurtillage800mBuffer_34,lyr_NaturalDesignatedAreasMergedTogetherTipperary_35,lyr_RiversTipperary_36,lyr_ArchaeologyTipperary_37,lyr_PowerLinesTipperary_38,lyr_PowerPolesTipperary_39,],
                                fold: "open",
...
lyr_ResidentialMixed800mCommercial500mHousingCurtilage_33.set('fieldAliases', {'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_HousingCurtillage800mBuffer_34.set('fieldAliases', {'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_NaturalDesignatedAreasMergedTogetherTipperary_35.set('fieldAliases', {'SITECODE': 'SITECODE', 'SITE_NAME': 'SITE_NAME', 'COUNTY': 'COUNTY', 'VERSION': 'VERSION', 'HA': 'HA', 'Source_CRS': 'Source_CRS', 'SourcScale': 'SourcScale', 'Shape_Leng': 'Shape_Leng', 'URL': 'URL', 'Shape__Are': 'Shape__Are', 'Shape__Len': 'Shape__Len', 'GlobalID': 'GlobalID', 'Shape_Le_1': 'Shape_Le_1', 'Shape_Area': 'Shape_Area', });
lyr_RiversTipperary_36.set('fieldAliases', {'EU_CD': 'EU_CD', 'NAME': 'NAME', 'MS_CD': 'MS_CD', 'REGION_CD': 'REGION_CD', 'INS_WHEN': 'INS_WHEN', 'INS_BY': 'INS_BY', 'BASIN_CD': 'BASIN_CD', 'LAT': 'LAT', 'LON': 'LON', 'LENGTHKM': 'LENGTHKM', 'SUB_CD': 'SUB_CD', 'DateChange': 'DateChange', 'Change': 'Change', 'GEOLOGY': 'GEOLOGY', 'AreaKm2': 'AreaKm2', 'AreaHectar': 'AreaHectar', 'Slope': 'Slope', 'Altitude': 'Altitude', 'WaterManag': 'WaterManag', 'EdenEntity': 'EdenEntity', 'Easting': 'Easting', 'Northing': 'Northing', 'LocalAutho': 'LocalAutho', 'SYSTEM': 'SYSTEM', 'TYPE': 'TYPE', 'ALT_CAT': 'ALT_CAT', 'SIZE_CAT': 'SIZE_CAT', 'DIST_CD': 'DIST_CD', 'ProtectedA': 'ProtectedA', 'WiseRefere': 'WiseRefere', 'HydroArea': 'HydroArea', 'StnDefinin': 'StnDefinin', });
lyr_ArchaeologyTipperary_37.set('fieldAliases', {'ENTITY_ID': 'ENTITY_ID', 'CLASS_CODE': 'CLASS_CODE', 'SMRS': 'SMRS', 'COUNTY': 'COUNTY', 'TOWNLAND': 'TOWNLAND', 'ZONE_ID': 'ZONE_ID', 'ITM_E': 'ITM_E', 'ITM_N': 'ITM_N', 'LATITUDE': 'LATITUDE', 'LONGITUDE': 'LONGITUDE', 'MONUMENT_C': 'MONUMENT_C', 'FIRST_EDIT': 'FIRST_EDIT', 'LATEST_EDI': 'LATEST_EDI', 'WEBSITE_LI': 'WEBSITE_LI', 'WEB_NOTES': 'WEB_NOTES', });
lyr_PowerLinesTipperary_38.set('fieldAliases', {'power': 'power', 'voltage': 'voltage', 'operator': 'operator', 'name': 'name', 'substation': 'substation', });
lyr_PowerPolesTipperary_39.set('fieldAliases', {'power': 'power', 'was_voltag': 'was_voltag', 'telecom': 'telecom', });
lyr_10mRoadBuffer_40.set('fieldAliases', {'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_Roads_41.set('fieldAliases', {'highway': 'highway', 'Shape_Leng': 'Shape_Leng', });
lyr_EircodesCreating800m_42.set('fieldAliases', {'EIRCODE': 'EIRCODE', 'ADDR_LINE1': 'ADDR_LINE1', 'ADDR_LIN_1': 'ADDR_LIN_1', 'ADDR_LIN_2': 'ADDR_LIN_2', 'ADDR_LIN_3': 'ADDR_LIN_3', 'ADDR_LIN_4': 'ADDR_LIN_4', 'ADDR_LIN_5': 'ADDR_LIN_5', 'ADDRESS_TY': 'ADDRESS_TY', 'NEAR_DIST': 'NEAR_DIST', 'Folio': 'Folio', 'Name': 'Name', });
lyr_IndicativeTurbineLocations25x35Ellipses_43.set('fieldAliases', {'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', 'RotDiam': 'RotDiam', 'Direct': 'Direct', 'WFactor': 'WFactor', 'LFactor': 'LFactor', 'Width': 'Width', 'Length': 'Length', });
lyr_875mOversail_44.set('fieldAliases', {'NoteType': 'NoteType', 'Name': 'Name', 'Notes': 'Notes', 'created_us': 'created_us', 'created_da': 'created_da', 'last_edite': 'last_edite', 'last_edi_1': 'last_edi_1', });
lyr_IndicativeTurbineLocations_45.set('fieldAliases', {'NoteType': 'NoteType', 'Name': 'Name', 'Notes': 'Notes', 'created_us': 'created_us', 'created_da': 'created_da', 'last_edite': 'last_edite', 'last_edi_1': 'last_edi_1', });
...
lyr_ResidentialMixed800mCommercial500mHousingCurtilage_33.set('fieldImages', {'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_HousingCurtillage800mBuffer_34.set('fieldImages', {'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_NaturalDesignatedAreasMergedTogetherTipperary_35.set('fieldImages', {'SITECODE': 'TextEdit', 'SITE_NAME': 'TextEdit', 'COUNTY': 'TextEdit', 'VERSION': 'TextEdit', 'HA': 'TextEdit', 'Source_CRS': 'TextEdit', 'SourcScale': 'TextEdit', 'Shape_Leng': 'TextEdit', 'URL': 'TextEdit', 'Shape__Are': 'TextEdit', 'Shape__Len': 'TextEdit', 'GlobalID': 'TextEdit', 'Shape_Le_1': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_RiversTipperary_36.set('fieldImages', {'EU_CD': 'TextEdit', 'NAME': 'TextEdit', 'MS_CD': 'TextEdit', 'REGION_CD': 'TextEdit', 'INS_WHEN': 'DateTime', 'INS_BY': 'TextEdit', 'BASIN_CD': 'TextEdit', 'LAT': 'TextEdit', 'LON': 'TextEdit', 'LENGTHKM': 'TextEdit', 'SUB_CD': 'TextEdit', 'DateChange': 'DateTime', 'Change': 'TextEdit', 'GEOLOGY': 'TextEdit', 'AreaKm2': 'TextEdit', 'AreaHectar': 'TextEdit', 'Slope': 'TextEdit', 'Altitude': 'TextEdit', 'WaterManag': 'TextEdit', 'EdenEntity': 'TextEdit', 'Easting': 'TextEdit', 'Northing': 'TextEdit', 'LocalAutho': 'TextEdit', 'SYSTEM': 'TextEdit', 'TYPE': 'TextEdit', 'ALT_CAT': 'TextEdit', 'SIZE_CAT': 'TextEdit', 'DIST_CD': 'TextEdit', 'ProtectedA': 'TextEdit', 'WiseRefere': 'TextEdit', 'HydroArea': 'TextEdit', 'StnDefinin': 'TextEdit', });
...
lyr_PowerLinesTipperary_38.set('fieldImages', {'power': 'TextEdit', 'voltage': 'TextEdit', 'operator': 'TextEdit', 'name': 'TextEdit', 'substation': 'TextEdit', });
lyr_PowerPolesTipperary_39.set('fieldImages', {'power': 'TextEdit', 'was_voltag': 'TextEdit', 'telecom': 'TextEdit', });
lyr_10mRoadBuffer_40.set('fieldImages', {'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_Roads_41.set('fieldImages', {'highway': 'TextEdit', 'Shape_Leng': 'TextEdit', });
lyr_EircodesCreating800m_42.set('fieldImages', {'EIRCODE': 'TextEdit', 'ADDR_LINE1': 'TextEdit', 'ADDR_LIN_1': 'TextEdit', 'ADDR_LIN_2': 'TextEdit', 'ADDR_LIN_3': 'TextEdit', 'ADDR_LIN_4': 'TextEdit', 'ADDR_LIN_5': 'TextEdit', 'ADDRESS_TY': 'TextEdit', 'NEAR_DIST': 'TextEdit', 'Folio': 'TextEdit', 'Name': 'TextEdit', });
lyr_IndicativeTurbineLocations25x35Ellipses_43.set('fieldImages', {'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', 'RotDiam': 'TextEdit', 'Direct': 'TextEdit', 'WFactor': 'TextEdit', 'LFactor': 'TextEdit', 'Width': 'TextEdit', 'Length': 'TextEdit', });
lyr_875mOversail_44.set('fieldImages', {'NoteType': '', 'Name': '', 'Notes': '', 'created_us': '', 'created_da': '', 'last_edite': '', 'last_edi_1': '', });
lyr_IndicativeTurbineLocations_45.set('fieldImages', {'NoteType': '', 'Name': 'TextEdit', 'Notes': '', 'created_us': '', 'created_da': '', 'last_edite': '', 'last_edi_1': '', });
...
lyr_PowerLinesTipperary_38.set('fieldLabels', {'power': 'no label', 'voltage': 'no label', 'operator': 'no label', 'name': 'no label', 'substation': 'no label', });
lyr_PowerPolesTipperary_39.set('fieldLabels', {'power': 'no label', 'was_voltag': 'no label', 'telecom': 'no label', });
lyr_10mRoadBuffer_40.set('fieldLabels', {'Shape_Leng': 'no label', 'Shape_Area': 'no label', });
lyr_Roads_41.set('fieldLabels', {'highway': 'no label', 'Shape_Leng': 'no label', });
lyr_EircodesCreating800m_42.set('fieldLabels', {'EIRCODE': 'no label', 'ADDR_LINE1': 'no label', 'ADDR_LIN_1': 'no label', 'ADDR_LIN_2': 'no label', 'ADDR_LIN_3': 'no label', 'ADDR_LIN_4': 'no label', 'ADDR_LIN_5': 'no label', 'ADDRESS_TY': 'no label', 'NEAR_DIST': 'no label', 'Folio': 'no label', 'Name': 'no label', });
lyr_IndicativeTurbineLocations25x35Ellipses_43.set('fieldLabels', {'Shape_Leng': 'no label', 'Shape_Area': 'no label', 'RotDiam': 'no label', 'Direct': 'no label', 'WFactor': 'no label', 'LFactor': 'no label', 'Width': 'no label', 'Length': 'no label', });
lyr_875mOversail_44.set('fieldLabels', {'NoteType': 'no label', 'Name': 'no label', 'Notes': 'no label', 'created_us': 'no label', 'created_da': 'no label', 'last_edite': 'no label', 'last_edi_1': 'no label', });
lyr_IndicativeTurbineLocations_45.set('fieldLabels', {'NoteType': 'no label', 'Name': 'header label - always visible', 'Notes': 'no label', 'created_us': 'no label', 'created_da': 'no label', 'last_edite': 'no label', 'last_edi_1': 'no label', });
lyr_IndicativeTurbineLocations_45.on('precompose', function(evt) {
